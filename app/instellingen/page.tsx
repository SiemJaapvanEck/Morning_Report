...
// component, mounted unchanged; MOR-18, Settings P4). Financiën (MOR-17,
// Phase 3) fetches the same portfolio/cashflow/goals + live quotes/FX shape
// as /financien and mounts InstellingenFinancienTab, which in turn mounts
// the unchanged FinancienGoals/FinancienHoldingForm components.
// Pipeline-rapport mounts today's edition report + trends (MOR-16, Phase 2 —
// see getPipelineReport() in app/lib/queries.ts).
// See docs/prd/settings-tabs.md (Phases 1-4).
